...
var app = new Vue({
    ...
    watch: {
        'bill.client': function billClient() {
    ...
    methods: {
        ...
        addBenfit: function addBenfit(idx) {
        ...
        removeBenefit: function removeBenefit(idx) {
            this.bill.benefits.splice(idx, 1);
        },
        error: function error(idx, field) {
            var key = 'benefit_' + idx + '_' + field;
            return errors[key];
        }
    }
});
