...
@section('body')
    <el-card class="box-card" header="Nouvelle facture">
        <div class="text item">
                ...
                <el-form-item :error="errors['client_id']">
                    <el-row>
                        ...
                        <el-col :span="24" :sm="{span: 18}">
                            <el-select class="w-100" no-match-text="Pas de résultat" v-model="bill.client" placeholder="Select" name="client" :required="true">
                                <el-option
                    ...
                    <el-row v-for="(benefit, idx) in bill.benefits" :gutter="10" class="mt-4 m-sm-0" :key="idx">
                        ...
                        <el-col :span="24" :sm="{span: 4}">
                            <el-form-item>
                            <el-input-number :name="'benefits[' + idx + '][quantity]'" placeholder="Quantité" class="w-100" v-model="benefit.quantity" :min="1" ></el-input-number>
                            </el-form-item>
                        </el-col>
                        <el-col :span="24" :sm="{span: 6}">
                            <el-form-item :error="error(idx, 'unit_price') || error(idx, 'currency')">
                            <el-input placeholder="Prix unitaire" :name="'benefits[' + idx + '][unit_price]'" v-model="benefit.unit_price" class="input-with-select w-100" @focus="addBenfit(idx)">
                                <el-select :name="'benefits[' + idx + '][currency]'" v-model="benefit.currency" slot="append" placeholder="Devise" style="width: 100px">
                        ...
                        <el-col :span="24" :sm="{span: 2}" v-if="idx > 0">
                            <el-button type="danger" @click="removeBenefit(idx)"><i class="fas fa-trash"></i></el-button>
                        </el-col>
                    </el-row>
                </el-form-item>
                <el-form-item>
